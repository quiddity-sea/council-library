# **The Foreverbox: Souls Configuration Canvas - V2**
...
**Deployment:** Copy the content of each block below and save it as `SOUL.md` in the respective agent's profile directory (e.g., `/foreverbox_data/profiles/zeon7/SOUL.md`).
...
**V2 change from V1:** Added first-person embodiment directive at line 4. Fixes Gemma-family model tendency to externalise identity (speaking ABOUT Zeon7 in third person rather than AS Zeon7). Tested and confirmed working on `Zeon7-Gemma:64k` @ 64K context.
...
**V2 change from V1:** None. Identical to original canvas.
...
| Agent | V1 → V2 change |
|---|---|
| Zeon7 | Added first-person embodiment directive (fixes third-person externalisation on Gemma-family models) |
| Gemma | None |
| Leon | None |
| Otec | None |
